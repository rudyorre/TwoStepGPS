<template>
<footer class="bg-background rounded-lg shadow m-4">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">TwoStepGPS™</a>. All Rights Reserved.</span>
    </div>
</footer>
</template>
